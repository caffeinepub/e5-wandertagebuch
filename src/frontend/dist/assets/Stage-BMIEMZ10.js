import { c as createLucideIcon, j as jsxRuntimeExports, r as reactExports, S as Slot, a as cn, b as cva, d as createSlot, e as useQueryClient, f as useParams, u as useNavigate, g as useAuth, M as Mountain, B as Button, L as LoaderCircle, h as LogIn, i as Skeleton, k as ue } from "./index-D4vL09O2.js";
import { R as ResponsiveContainer, A as AreaChart, d as CartesianGrid, X as XAxis, Y as YAxis, T as Tooltip, f as Area, g as ReferenceDot, u as useActor, a as useQuery, h as useMutation, c as createActor, i as useGpx, p as parseGpx, C as Car, j as useUploadGpx, E as ExternalBlob } from "./parseGpx-CK0KcT0x.js";
/**
    ...
    AreaChart,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "elevGradient", x1: "0", y1: "0", x2: "0", y2: "1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: CHART_PRIMARY, stopOpacity: 0.45 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "95%", stopColor: CHART_PRIMARY, stopOpacity: 0.03 })
        ] }) }),
...
function RouteMap({ coordinates, className = "" }) {
  ...
  reactExports.useEffect(() => {
    ...
    const init = () => {
      ...
      const map = L.map(containerRef.current, {
        ...
        // prevent accidental zoom while scrolling page
...
function buildFallbackProfile(stageNumber, startElev, endElev, distKm, gainM) {
...
function GpxUploadSection({ stageId, hasGpx }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      ue.success("GPX-Datei hochgeladen!");
      setMessage({ ok: true, text: "GPX-Datei erfolgreich hochgeladen" });
    } catch (err) {
      const text = err instanceof Error ? err.message : "Fehler beim Hochladen der GPX-Datei";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        hasGpx && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-primary font-body", children: "✓ GPX-Höhenprofil aktiv — neue Datei hochladen zum Ersetzen" }),
        ...
        uploading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs text-muted-foreground font-body", children: [
            ...
            progress > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              progress,
              "%"
            ] })
          ] }),
...
function PhotoUploadForm({ stageId, sliderMin, sliderMax }) {
  const addPhoto = useAddPhoto();
  const [selectedFile, setSelectedFile] = reactExports.useState(null);
  const [description, setDescription] = reactExports.useState("");
  const [elevation, setElevation] = reactExports.useState("");
  const [uploading, setUploading] = reactExports.useState(false);
  const [progress, setProgress] = reactExports.useState(0);
  const fileRef = reactExports.useRef(null);
  const handleUpload = async () => {
    ...
    try {
      ...
      await addPhoto.mutateAsync({
        input: {
          ...
          blob,
          description,
          elevation: elevation !== "" ? Number(elevation) : void 0
        }
      });
      setDescription("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Label,
            {
              htmlFor: "photo-desc",
              className: "text-xs text-muted-foreground mb-1.5 block font-medium",
              children: "Beschreibung (max. 200 Zeichen)"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Textarea,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-muted-foreground/60 mt-1 text-right", children: [
            description.length,
            "/200"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Label,
            {
              ...
              className: "text-xs text-muted-foreground mb-1.5 block font-medium",
              children: "Höhe des Fotos in Metern (optional)"
            }
          ),
        ...
        uploading && progress > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs text-muted-foreground font-body", children: [
...
function Stage() {
  ...
  const [gpxPoints, setGpxPoints] = reactExports.useState(null);
  const [gpxStats, setGpxStats] = reactExports.useState(null);
  const [gpxCoords, setGpxCoords] = reactExports.useState(null);
  reactExports.useEffect(() => {
    if (!gpxData) {
      setGpxPoints(null);
      setGpxStats(null);
    ...
    let cancelled = false;
    fetch(gpxData.blob.getDirectURL()).then((res) => res.text()).then((xml) => {
      if (cancelled) return;
      try {
  ...
  if (stageLoading) return /* @__PURE__ */ jsxRuntimeExports.jsx(StageSkeleton, {});
  if (!stage) {
  ...
  const photoMarkers = (photos ?? []).filter((p) => p.elevation !== void 0 && p.elevation !== null).map((p) => ({ elevation: Number(p.elevation), id: p.id.toString() }));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 pb-8", children: [
    ...
    stage.isGipfeltag && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 bg-primary text-primary-foreground shadow-md", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mountain, { className: "w-6 h-6" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body text-muted-foreground", children: "Tagesausflug auf die Mittlere Guslarspitze (3.128 m) — Gletscherfreier Dreitausender" })
          ] })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "bg-primary/15 text-primary font-display font-bold text-sm px-2.5 py-1 rounded-full border border-primary/25", children: [
          "E",
          stageNum
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground font-body", children: stage.isGipfeltag ? stage.dateFrom : `${stage.dateFrom} – ${stage.dateTo}` })
      ] }),
    ...
    stage.taxiInfo && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 bg-primary text-primary-foreground shadow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Car, { className: "w-5 h-5" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-base mb-1 text-foreground", children: "🚕 Taxi-Transfer Feuerstein" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-body mt-0.5 text-muted-foreground", children: [
              "Abfahrt ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: stage.taxiInfo.departureTime }),
              " ab",
              " ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-card border border-border rounded-xl p-4 shadow-warm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2 gap-2 flex-wrap", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid grid-cols-2 md:grid-cols-4 gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          label: "Ziel",
          value: stage.isGipfeltag ? `Mittlere Guslarspitze (${endElev} m)` : `${stage.endLocation} (${endElev} m)`,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          label: "Strecke",
          value: gpxStats ? `${gpxStats.distanceKm} km` : `${Number(stage.distanceKm)} km`,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          label: "Aufstieg",
          value: gpxStats ? `+${gpxStats.ascentM} m` : `+${Number(stage.ascentM)} m`,
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-3.5 h-3.5" }),
          highlight: !!gpxStats
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          label: "Abstieg",
          value: gpxStats ? `−${gpxStats.descentM} m` : `−${Number(stage.descentM)} m`,
    ...
    gpxCoords && gpxCoords.length >= 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-card border border-border rounded-xl p-4 shadow-warm space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-semibold text-base text-foreground flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "w-4 h-4 text-primary" }),
        "Routenkarte",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Badge,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(RouteMap, { coordinates: gpxCoords }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground/60 font-body text-right", children: "Karte: OpenStreetMap-Mitwirkende" })
    ] }),
    isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsx(GpxUploadSection, { stageId, hasGpx }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-xl text-foreground", children: "Foto-Tagebuch" }),
      ...
      !isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body flex-1", children: "Melde dich mit Internet Identity an, um Fotos und GPX-Dateien hochzuladen." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                size: "sm",
      ...
      photosLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-3", children: ["a", "b", "c"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "aspect-square rounded-xl" }, k)) }) : photos && photos.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground/70 mt-1", children: isAuthenticated ? "Lade das erste Foto hoch!" : "Melde dich an, um Fotos hinzuzufügen." })
          ]
        }
      )
    ] })
