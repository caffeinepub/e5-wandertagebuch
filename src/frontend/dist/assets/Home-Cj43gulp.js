import { r as reactExports, j as jsxRuntimeExports, M as Mountain, u as useNavigate } from "./index-D4vL09O2.js";
import { C as Car, u as useActor, a as useQuery, c as createActor, b as useAllGpx, p as parseGpx, R as ResponsiveContainer, A as AreaChart, d as CartesianGrid, e as ReferenceLine, X as XAxis, Y as YAxis, T as Tooltip, f as Area } from "./parseGpx-CK0KcT0x.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      className: [
        ...
        isActive ? "bg-primary/10 border-primary/50 shadow-warm" : "bg-card border-border hover:border-primary/30"
      ].join(" "),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "span",
          {
            className: [
              ...
              isActive ? "bg-primary text-primary-foreground" : "bg-primary/15 text-primary group-hover:bg-primary/25"
            ].join(" "),
            children: [
              "E",
              num
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display font-semibold text-sm text-foreground truncate leading-tight", children: [
            stage.startLocation,
            " → ",
            stage.endLocation
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 items-end flex-shrink-0", children: [
          stage.isGipfeltag && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-semibold bg-accent/20 text-accent-foreground border border-accent/30", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mountain, { className: "w-2.5 h-2.5" }),
            "Gipfeltag"
          ] }),
          stage.taxiInfo && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-semibold bg-destructive/10 text-destructive border border-destructive/20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Car, { className: "w-2.5 h-2.5" }),
            "Taxi"
          ] })
        ] })
      ]
...
function buildTourProfile(gpxOverrides) {
  const points = [];
  let cumKm = 0;
  for (let n = 1; n <= 12; n++) {
...
function buildBoundaries(gpxOverrides) {
  const result = [];
  let cumKm = 0;
  for (let n = 1; n <= 12; n++) {
    const gpxPoints = gpxOverrides[n];
...
function TourTooltip({ active, payload, label }) {
  var _a, _b;
  if (!active || !(payload == null ? void 0 : payload.length)) return null;
  const pt = (_a = payload[0]) == null ? void 0 : _a.payload;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg px-3 py-2 shadow-warm-elevated text-sm", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display font-bold text-foreground", children: [
      (_b = payload[0]) == null ? void 0 : _b.value,
      " m ü.M."
    ] }),
    (pt == null ? void 0 : pt.label) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary text-xs mt-0.5", children: pt.label })
  ] });
}
const SKELETON_KEYS = [
  "s1",
...
function Home() {
  ...
  const [gpxOverrides, setGpxOverrides] = reactExports.useState({});
  reactExports.useEffect(() => {
  ...
  const tourProfile = Object.keys(gpxOverrides).length > 0 ? buildTourProfile(gpxOverrides) : STATIC_TOUR_PROFILE;
  const boundaries = Object.keys(gpxOverrides).length > 0 ? buildBoundaries(gpxOverrides) : STATIC_BOUNDARIES;
  ...
  function goToStage(id2) {
    void navigate({ to: "/etappe/$id", params: { id: id2 } });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.section,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground leading-tight", children: "E5 Wandertagebuch Schreiber" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg text-primary mt-1", children: "Oberstdorf → Meran · August 2026" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body max-w-xl mx-auto mt-3 text-sm sm:text-base leading-relaxed", children: "Unser Wandertagebuch für die Alpenüberquerung — 12 Etappen, Gletscher, Berghütten und ein Gipfeltag mit der ganzen Familie." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto grid grid-cols-2 sm:grid-cols-4", children: TOUR_STATS.map(({ label, value }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: [
              "flex flex-col items-center py-4 px-3",
              i % 2 === 0 ? "border-r border-border/50" : "",
              i < TOUR_STATS.length - 1 ? "sm:border-r sm:border-border/50" : "sm:border-r-0"
            ].join(" "),
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-2xl font-bold text-primary", children: value }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.section,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl sm:text-2xl font-bold text-foreground mb-1", children: "Gesamthöhenprofil" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-4", children: "Alle 12 Etappen — von Oberstdorf bis Meran. Hover für Details." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  AreaChart,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "tourGrad", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "stop",
                          {
                            offset: "5%",
                      ...
                      boundaries.map(({ km, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        ReferenceLine,
                        {
                          x: km,
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: /* @__PURE__ */ jsxRuntimeExports.jsx(TourTooltip, {}) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Area,
                        {
                          type: "monotone",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap justify-between text-xs text-muted-foreground mt-2 px-1 gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Start: Oberstdorf 813 m" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Höchstpunkt: Guslarspitze 3.128 m" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Ziel: Meran 325 m" })
                ] })
              ]
            }
          )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.section,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl sm:text-2xl font-bold text-foreground mb-1", children: "Alle Etappen" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-5", children: "Klicke auf eine Etappe für Höhenprofil, Infos und Fotos." }),
          isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-3", children: SKELETON_KEYS.map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-20 bg-muted rounded-lg animate-pulse" }, k)) }) : sortedStages.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-3", children: sortedStages.map((stage, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-3", children: STATIC_STAGES.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.button,
              {
                type: "button",
                initial: { opacity: 0, y: 10 },
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex-shrink-0 w-9 h-9 rounded-full flex items-center justify-center font-display font-bold text-sm bg-primary/15 text-primary group-hover:bg-primary/25", children: [
                    "E",
                    s.num
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 items-end flex-shrink-0", children: [
                    s.isGipfeltag && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-semibold bg-accent/20 text-accent-foreground border border-accent/30", children: "Gipfeltag" }),
                    s.hasTaxi && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-semibold bg-destructive/10 text-destructive border border-destructive/20", children: "Taxi" })
                  ] })
                ]
              },
              s.id
