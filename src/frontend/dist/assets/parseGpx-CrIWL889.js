...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, k as utf8ToBytes, E as ExternalError, l as MissingRootKeyErrorCode, C as Certificate, m as lookupResultToBuffer, R as RequestStatusResponseStatus, U as UnknownError, n as RequestStatusDoneNoReplyErrorCode, o as RejectError, p as CertifiedRejectErrorCode, q as UNREACHABLE_ERROR, I as InputError, s as InvalidReadStateRequestErrorCode, t as ReadRequestType, v as Principal, w as IDL, x as MissingCanisterIdErrorCode, H as HttpAgent, y as encode, Q as QueryResponseStatus, z as UncertifiedRejectErrorCode, A as isV3ResponseBody, D as isV2ResponseBody, F as UncertifiedRejectUpdateErrorCode, G as UnexpectedErrorCode, J as decode, K as Subscribable, N as pendingThenable, O as resolveEnabled, V as shallowEqualObjects, W as resolveStaleTime, X as noop$3, Y as environmentManager, Z as isValidTimeout, _ as timeUntilStale, $ as timeoutManager, a0 as focusManager, a1 as fetchState, a2 as replaceData, a3 as notifyManager, a4 as hashKey, a5 as getDefaultState, r as reactExports, a6 as shouldThrowError, e as useQueryClient, a7 as useInternetIdentity, a8 as createActorWithConfig, c as createLucideIcon, a9 as commonjsGlobal, aa as getDefaultExportFromCjs, ab as clsx, ac as React, ad as invariant, ae as Record, af as Opt, ag as Vec, ah as Service, ai as Func, aj as Variant, ak as Nat, al as Nat8, am as Text$1, an as Bool, ao as Principal$1, ap as Int, aq as Null } from "./index-xv5N8Qko.js";
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const Stage2 = IDL2.Record({
    "id": StageId2,
    "dateTo": IDL2.Text,
    "endElevation": IDL2.Nat,
    "startElevation": IDL2.Nat,
    "taxiInfo": IDL2.Opt(TaxiInfo2),
    "accommodation": IDL2.Text,
    "estimatedTimeH": IDL2.Nat,
    "elevationLossM": IDL2.Nat,
    "distanceKm": IDL2.Nat,
    "isGipfeltag": IDL2.Bool,
    "endLocation": IDL2.Text,
    "elevationGainM": IDL2.Nat,
    "number": IDL2.Nat,
    "dateFrom": IDL2.Text,
  ...
  return IDL2.Service({
    ...
    "getGpx": IDL2.Func(
      [StageId2],
      [IDL2.Variant({ "ok": GpxData2, "err": IDL2.Text })],
      ["query"]
    ),
...
async function from_candid_GpxData_n15(_uploadFile, _downloadFile, value) {
...
function from_candid_Stage_n19(_uploadFile, _downloadFile, value) {
...
async function from_candid_variant_n14(_uploadFile, _downloadFile, value) {
  return "ok" in value ? {
    __kind__: "ok",
...
function from_candid_vec_n22(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_Stage_n19(_uploadFile, _downloadFile, x2));
}
