import { d as createLucideIcon, j as jsxRuntimeExports, S as Slot, e as cn, f as cva, u as useActor, a as useQuery, g as useQueryClient, c as createActor, h as useParams, b as useNavigate, i as useAuth, r as reactExports, k as Skeleton, M as Mountain, B as Button, L as LoginModal, l as Label, I as Input, m as Lock, X, E as ExternalBlob, n as ue } from "./index-CxvkZgBe.js";
import { R as ResponsiveContainer, A as AreaChart, a as CartesianGrid, X as XAxis, Y as YAxis, T as Tooltip, c as Area, d as ReferenceDot, e as useMutation, f as useGpx, g as useUploadGpx, p as parseGpx, C as Car } from "./parseGpx-B1PKUCho.js";
/**
...
function Stage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 pb-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(LoginModal, { open: loginOpen, onClose: () => setLoginOpen(false) }),
    ...
    isAuthenticated && token && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
        ...
        !isValidating && !isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            variant: "outline",
            size: "sm",
      ...
      !isValidating && !isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "w-4 h-4 text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body flex-1", children: "Melde dich an, um Fotos und Notizen zu dieser Etappe hinzuzufügen." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                size: "sm",
          ...
          children: photos.map((photo) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                isAuthenticated && token && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
