...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, l as utf8ToBytes, E as ExternalError, m as MissingRootKeyErrorCode, C as Certificate, n as lookupResultToBuffer, R as RequestStatusResponseStatus, U as UnknownError, o as RequestStatusDoneNoReplyErrorCode, p as RejectError, q as CertifiedRejectErrorCode, s as UNREACHABLE_ERROR, I as InputError, t as InvalidReadStateRequestErrorCode, v as ReadRequestType, w as Principal, x as IDL, y as MissingCanisterIdErrorCode, H as HttpAgent, z as encode, Q as QueryResponseStatus, A as UncertifiedRejectErrorCode, D as isV3ResponseBody, F as isV2ResponseBody, G as UncertifiedRejectUpdateErrorCode, J as UnexpectedErrorCode, K as decode, N as Subscribable, O as pendingThenable, V as resolveEnabled, W as shallowEqualObjects, X as resolveStaleTime, Y as noop$3, Z as environmentManager, _ as isValidTimeout, $ as timeUntilStale, a0 as timeoutManager, a1 as focusManager, a2 as fetchState, a3 as replaceData, a4 as notifyManager, a5 as hashKey, a6 as getDefaultState, r as reactExports, a7 as shouldThrowError, e as useQueryClient, a8 as useInternetIdentity, a9 as createActorWithConfig, c as createLucideIcon, aa as commonjsGlobal, ab as getDefaultExportFromCjs, ac as clsx, ad as React, ae as invariant, af as Record, ag as Opt, ah as Vec, ai as Service, aj as Func, ak as Nat, al as Nat8, am as Text$1, an as Bool, ao as Float64, ap as Principal$1, aq as Int } from "./index-D4vL09O2.js";
...
function hasProperty(value, property2) {
  return Object.prototype.hasOwnProperty.call(value, property2);
}
function isObjectWithProperty(value, property2) {
  return value !== null && typeof value === "object" && hasProperty(value, property2);
}
function hasFunction(value, property2) {
  return hasProperty(value, property2) && typeof value[property2] === "function";
}
    ...
    class CanisterActor extends Actor {
      constructor(config2) {
        if (!config2.canisterId) {
          throw InputError.fromCode(new MissingCanisterIdErrorCode(config2.canisterId));
        }
        const canisterId = typeof config2.canisterId === "string" ? Principal.fromText(config2.canisterId) : config2.canisterId;
        super({
          config: {
...
function useActor(createActor2) {
  ...
  const actorQuery = useQuery({
    queryKey: [ACTOR_QUERY_KEY, identity3 == null ? void 0 : identity3.getPrincipal().toString()],
    queryFn: async () => {
...
const PhotoInput = Record({
  "elevation": Opt(Float64),
  "stageId": StageId,
  "blob": ExternalBlob$1,
  "description": Text$1
});
...
const GpxData = Record({
  "stageId": StageId,
  "blob": ExternalBlob$1,
  "uploadedAt": Int
});
const TaxiInfo = Record({
  "departureLocation": Text$1,
  "departureTime": Text$1,
  "pricePerPerson": Text$1,
  "phone": Text$1
});
const Stage = Record({
  "id": StageId,
  ...
  "endElevation": Int,
  "startElevation": Int,
  "taxiInfo": Opt(TaxiInfo),
  "accommodation": Text$1,
  "estimatedTimeH": Float64,
  "distanceKm": Float64,
  "isGipfeltag": Bool,
  "endLocation": Text$1,
  "number": Nat,
  "dateFrom": Text$1,
  "startLocation": Text$1,
  "descentM": Int
});
Service({
  ...
  "addPhoto": Func([PhotoInput], [Photo], []),
  "deletePhoto": Func([PhotoId], [Bool], []),
  "getGpx": Func([StageId], [Opt(GpxData)], ["query"]),
  "getPhotos": Func([StageId], [Vec(Photo)], ["query"]),
  "getStage": Func([StageId], [Opt(Stage)], ["query"]),
  "getStages": Func([], [Vec(Stage)], ["query"]),
  "uploadGpx": Func([StageId, ExternalBlob$1], [], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const StageId2 = IDL2.Nat;
  const ExternalBlob2 = IDL2.Vec(IDL2.Nat8);
  const PhotoInput2 = IDL2.Record({
    "elevation": IDL2.Opt(IDL2.Float64),
    "stageId": StageId2,
    "blob": ExternalBlob2,
  ...
  const GpxData2 = IDL2.Record({
    "stageId": StageId2,
    "blob": ExternalBlob2,
    "uploadedAt": IDL2.Int
  });
  const TaxiInfo2 = IDL2.Record({
    "departureLocation": IDL2.Text,
    "departureTime": IDL2.Text,
    "pricePerPerson": IDL2.Text,
    "phone": IDL2.Text
  });
  const Stage2 = IDL2.Record({
    "id": StageId2,
    "ascentM": IDL2.Int,
    "dateTo": IDL2.Text,
    "endElevation": IDL2.Int,
    "startElevation": IDL2.Int,
    "taxiInfo": IDL2.Opt(TaxiInfo2),
    "accommodation": IDL2.Text,
    "estimatedTimeH": IDL2.Float64,
    "distanceKm": IDL2.Float64,
    "isGipfeltag": IDL2.Bool,
    "endLocation": IDL2.Text,
    "number": IDL2.Nat,
    "dateFrom": IDL2.Text,
    "startLocation": IDL2.Text,
    "descentM": IDL2.Int
  });
  return IDL2.Service({
    ...
    "addPhoto": IDL2.Func([PhotoInput2], [Photo2], []),
    "deletePhoto": IDL2.Func([PhotoId2], [IDL2.Bool], []),
    "getGpx": IDL2.Func([StageId2], [IDL2.Opt(GpxData2)], ["query"]),
    "getPhotos": IDL2.Func([StageId2], [IDL2.Vec(Photo2)], ["query"]),
    "getStage": IDL2.Func([StageId2], [IDL2.Opt(Stage2)], ["query"]),
    "getStages": IDL2.Func([], [IDL2.Vec(Stage2)], ["query"]),
    "uploadGpx": IDL2.Func([StageId2, ExternalBlob2], [], [])
  });
};
...
async function from_candid_GpxData_n16(_uploadFile, _downloadFile, value) {
  return await from_candid_record_n17(_uploadFile, _downloadFile, value);
}
async function from_candid_Photo_n11(_uploadFile, _downloadFile, value) {
  return await from_candid_record_n12(_uploadFile, _downloadFile, value);
}
function from_candid_Stage_n20(_uploadFile, _downloadFile, value) {
...
async function from_candid_vec_n18(_uploadFile, _downloadFile, value) {
  return await Promise.all(value.map(async (x2) => await from_candid_Photo_n11(_uploadFile, _downloadFile, x2)));
}
function from_candid_vec_n23(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_Stage_n20(_uploadFile, _downloadFile, x2));
}
async function to_candid_ExternalBlob_n10(_uploadFile, _downloadFile, value) {
  return await _uploadFile(value);
}
async function to_candid_PhotoInput_n8(_uploadFile, _downloadFile, value) {
...
function useGpx(stageId) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["gpx", stageId == null ? void 0 : stageId.toString()],
    queryFn: async () => {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      try {
        ...
        throw new Error(
          `GPX-Datei konnte nicht gelesen werden: ${e3 instanceof Error ? e3.message : String(e3)}`
        );
      }
      let blob;
      try {
        ...
        throw new Error(
          `GPX-Datei konnte nicht verarbeitet werden: ${e3 instanceof Error ? e3.message : String(e3)}`
        );
      }
      if (onProgress) {
